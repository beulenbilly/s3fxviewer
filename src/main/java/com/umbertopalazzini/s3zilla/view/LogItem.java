...
/**
 * View purpose class in order to well organize data in the logTable. Fields
 * needed: - local file name - remote file name (I retrieve it from the
 * transfer) - progress (it's simply a progress bar) - size (I retrieve it from
 * the transfer) - status
 */
public class LogItem {
    ...
    /**
     * If the transfer is a Download retrieve its full path (on S3). Otherwise
